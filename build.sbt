...
val sharedConfig = Seq(
    ...
    // ----------------------- Bloop / SBT shared settings -------------------------------------------
    // Add conf/ directory to classpath for running and tests (NOT packaged in JAR)
    ...
    Test / unmanagedClasspath += Attributed.blank(baseDirectory.value / "conf"),
